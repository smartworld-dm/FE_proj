...
/*User Admin*/
import { Dasboard, Deposit, KYC, MyReferrals, Promotion, PaymentDetails, ReferEarn, TransferFunds, Work, Withdraw, Settings, BrowseWebsite, WatchVideo, ContactUs } from './scenes/user-admin';
/*Route Paths*/
...
export default (
    <HashRouter>
        <PageWrapper>
            <Switch>
                <Route path={paths.getContactUsPath.mask} component={routerWrapper(ContactUs, false, false)}/>
